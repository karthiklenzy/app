    ...
    <div class="content">
    	<div class="section group">
			...
			<div class="row" id="ads">
				<h3 class="product-head">Bid Items</h3>
				<!-- Category Card -->
			...
			<div class="content-pagenation" <?php if ($total_product < 1) { echo "style='display: none'";} ?>>
					<li><a href="<?php echo HTTP_PATH ?>bid-list?currentpage=1">First</a></li>
					<?php for ($x=1; $x <= $total_pages ; $x++) { if(($x <= $showmaxpagelimit) && ($x >= $showminpagelimit)){ ?>
					<li <?php if($current_page_number == $x){ ?> class="active" <?php } ?>><a href="<?php echo HTTP_PATH ?>bid-list?currentpage=<?php echo $x; ?>" ><?php echo $x; ?></a></li>
						<?php } } ?>
					<li><a href="<?php echo HTTP_PATH ?>bid-list?currentpage=<?php echo $total_pages ?>">Last</a></li>
				<div class="clear"></div>
			</div>
		</div>		
    </div> 
