    	...
    	<div class="section group">
			...
			<div class="row" id="ads">
			 ...
			 <div class="content-pagenation" <?php if ($total_product < 1) { echo "style='display: none'";} ?>>
					<li><a href="<?php echo HTTP_PATH ?>uploaded-items?currentpage=1">First</a></li>
					<?php for ($x=1; $x <= $total_pages ; $x++) { if(($x <= $showmaxpagelimit) && ($x >= $showminpagelimit)){ ?>
					<li <?php if($current_page_number == $x){ ?> class="active" <?php } ?>><a href="<?php echo HTTP_PATH ?>uploaded-items?currentpage=<?php echo $x; ?>" ><?php echo $x ?></a></li>
						<?php } } ?>
					<li><a href="<?php echo HTTP_PATH ?>uploaded-items?currentpage=<?php echo $total_pages ?>">Last</a></li>
				<div class="clear"></div>
			</div> 
		</div>		
    </div> 
