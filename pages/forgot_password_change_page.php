    		...
    		<div class="row">
    		 <div class="container">
    			<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    <li class="breadcrumb-item"><a href="<?php echo HTTP_PATH; ?>forgot-password">Forgot Password Change</a></li>
				...
				<div class="col-md-6">
					  <div class="contact-form" style="padding: 25px 15px 0px 15px;">
					  		...
					  		<form method="post">
							    ...
							    <div>
							    	<span><label>New Password</label></span><span class="star"> *</span>
							    	<span><input type="password" name="valid_password_one" class="textbox" id="passwordone" required></span>
							    </div>
							    <div>
							    	<span><label>Retype New Password</label></span><span class="star"> *</span>
							    	<span><input type="password" name="valid_password_two" class="textbox" id="passwordtwo" required></span>
							    </div>
 	...
 	<div class="modal-dialog">
	  ...
	  <div class="modal-content">
	    <div class="modal-header">
	      ...
	      <h4 class="modal-title">Password chagne</h4>
	    </div>
...
<script>
$('#passwordone').keydown(function(e) {
    if (e.keyCode == 32) {
        return false;
    }
});
$('#passwordtwo').keydown(function(e) {
    if (e.keyCode == 32) {
        return false;
    }
});
