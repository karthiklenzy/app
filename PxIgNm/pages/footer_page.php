								...
								<form class="form-inline" action="#" method="post">
									...
									<div style="width:100%; margin-bottom: 10px;">
										<div class="form-group">
											<input type="hidden" name="hiddenmenuitemid<?php echo $i; ?>" value="">
											<label for="exampleInputName2">Name : </label>
											<input type="text" name="txtmenuitem" class="form-control" value="">
										</div>
										<div class="form-group">
											<label for="exampleInputEmail2">URL :</label>
											<input type="text" name="txtmenuitemlink<?php echo $i; ?>" class="form-control" value="">
										</div>
										
										<div class="form-group">
											
											<a href="#" title="delete" onclick="return confirm('Are you sure you want to delete?')">
