...
$verify_count = 0;
	...
	if (isset($_GET['product-url'])) {
		...
		$product_name_to_display = $product_catagory_sql[0]['product_name'];
				...
				if ($product_max_ex_value != "") {
					...
					// Mail to ex bidder
	      			if ($to != $current_email) {
                    	...
                    	$the_message_to_be_sent .= '<br><br><b>Name :</b> '.$product_name_to_display.'<br><b>Total views :</b> '.$product_view_mail.'<br><b>Bid end on :</b> '.$product_bidend_mail;
